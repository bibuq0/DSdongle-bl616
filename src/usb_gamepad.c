...
#include "queue.h"
  ...
  #ifdef FORCE_FS_MODE
    #define FIRMWARE_VERSION "LCT616-DS5 3.19.17"
  #else
    #define FIRMWARE_VERSION "LCT616-DS5 3.19.17H"
  #endif
...
#define HID_REPORT_DESC_SIZE_DSE 481
...
static const uint8_t hid_report_desc_dse[HID_REPORT_DESC_SIZE_DSE] = {
    ...
    /* DSE-specific Feature Reports — 63 data bytes each so the reported
     * size matches the 64-byte payloads the firmware actually exchanges
     * (otherwise strict hosts reject GET/SET for these reports). */
    ,
    ...
    0x85, 0xF9, 0x09, 0x3A, 0x95, 0x3F, 0xB1, 0x02,
     0x85, 0xFB, 0x09, 0x3C, 0x95, 0x50, 0xB1, 0x02,  /* button remap table (80) */
     0xC0,
};
